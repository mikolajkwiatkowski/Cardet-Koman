...
function KafelekPracownik({ pfp, name, description, width, height }) {
  return (
    <motion.div
      className={`flex flex-col bg-neutral-900 hover:bg-yellow-500 border-3  shadow-2xl border-yellow-500  hover:text-neutral-800 rounded-4xl drop-shadow-xl items-center p-6 transition-transform duration-300 hover:scale-105 ${poppins.className}`}
      style={{ width, height }}
